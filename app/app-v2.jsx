...
const IcCards=()=> <svg viewBox="0 0 24 24" fill="none"><rect x="6.5" y="7.6" width="13" height="10.4" rx="2.4" fill="#A9DEA0"/><rect x="4.5" y="5" width="13" height="10.4" rx="2.4" fill="#5CB85C"/><path d="M7.6 8.4h6.9M7.6 11.2h4.2" stroke="#fff" strokeWidth="1.5" strokeLinecap="round"/></svg>;
const IcQuiz=()=> <svg viewBox="0 0 24 24" fill="none"><rect x="5" y="4.2" width="14" height="16.3" rx="2.6" fill="#FBD38D"/><rect x="8.7" y="2.6" width="6.6" height="3.6" rx="1.3" fill="#F0654F"/><path d="M8.6 13l2.4 2.4 4.4-4.7" stroke="#F0654F" strokeWidth="2.1" strokeLinecap="round" strokeLinejoin="round"/></svg>;
...
const IcSpeaker=()=> <svg viewBox="0 0 24 24" fill="none"><path d="M4 9h3.5L12 5v14l-4.5-4H4z" fill="#3FA9D6"/><path d="M15.4 9a4 4 0 0 1 0 6M17.9 6.5a7.5 7.5 0 0 1 0 11" stroke="#3FA9D6" strokeWidth="1.9" strokeLinecap="round"/></svg>;
const IcPin=()=> <svg viewBox="0 0 24 24" fill="#F0654F"><path d="M9 3h6a1 1 0 0 1 0 2h-.6l.7 6 1.9 1.9a1 1 0 0 1-.7 1.7H13v4.9a1 1 0 0 1-2 0V14.6H7.7a1 1 0 0 1-.7-1.7L8.9 11l.7-6H9a1 1 0 0 1 0-2z"/></svg>;
